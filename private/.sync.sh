...
PORT_TARGET=22 # ssh port (inside port is 22) 
...
/usr/bin/ssh -p $PORT_TARGET $USER_TARGET@$HOST_TARGET "mkdir -p ${PATH_TARGET}/screenshots"
...
scp -P $PORT_TARGET -rp $SRC/screenshots/.fake.png $USER_TARGET@$HOST_TARGET:$PATH_TARGET/screenshots/.fake.png
scp -P $PORT_TARGET -rp $SRC/screenshots/scrennshot_1.png $USER_TARGET@$HOST_TARGET:$PATH_TARGET/screenshots/scrennshot_1.png
scp -P $PORT_TARGET -rp $SRC/screenshots/scrennshot_2.png $USER_TARGET@$HOST_TARGET:$PATH_TARGET/screenshots/scrennshot_2.png
scp -P $PORT_TARGET -rp $SRC/screenshots/wallpaper.png $USER_TARGET@$HOST_TARGET:$PATH_TARGET/screenshots/wallpaper.png
...
/usr/bin/ssh -p $PORT_TARGET $USER_TARGET@$HOST_TARGET "sudo mkdir -p ${NODE_MODULE_TARGET}/screenshots"
...
scp -P $PORT_TARGET -rp $SRC/screenshots/.fake.png $USER_TARGET@$HOST_TARGET:$NODE_MODULE_TARGET/screenshots/.fake.png
scp -P $PORT_TARGET -rp $SRC/screenshots/scrennshot_1.png $USER_TARGET@$HOST_TARGET:$NODE_MODULE_TARGET/screenshots/scrennshot_1.png
scp -P $PORT_TARGET -rp $SRC/screenshots/scrennshot_2.png $USER_TARGET@$HOST_TARGET:$NODE_MODULE_TARGET/screenshots/scrennshot_2.png
scp -P $PORT_TARGET -rp $SRC/screenshots/wallpaper.png $USER_TARGET@$HOST_TARGET:$NODE_MODULE_TARGET/screenshots/wallpaper.png
